...
generateTemplateNameIDStylesheet();

// SET PAGES & STYLESHEET PROPS
function setPagesStylesheetProp() {
...
function addStylesheetsToTemplate() {
	dbStylesheets.find({}, {_id:0, id:1, name: 1}, function (err, docs) {
		console.log(docs);
	})
}

addStylesheetsToTemplate();